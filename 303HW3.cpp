// 303HW3.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    elements.push(14);
    elements.push(2);
    //for (int i = 0; i < 10; i++) //this adds 10 integers to the queue using the push function
    //{
    //    elements.push(i);
    //};
